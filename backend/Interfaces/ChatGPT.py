# ChatGPT Interface for Depression Signal Extraction utilizing Groq's Api
...
def extract_signals(text: str, prompt_type: str = "simple") -> dict:
    """
    Use ChatGPT (Groq) to analyze text for depression-related linguistic signals.
...
def analyze_text(text: str, prompt_type: str = "simple") -> dict:
    """
    Full pipeline: Extract signals via ChatGPT and return result.
    """
