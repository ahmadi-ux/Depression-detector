...
*/
export default function DataUpload({ onShowResult }) {
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" className="w-full">Select Model: {selectedLLM}</Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent className="z-50 bg-white text-black shadow-xl border rounded-md p-1 w-full">
